...
import { AppBar, Toolbar, Button, Avatar, ButtonBase, Tabs, Tab, Modal, Typography } from '@material-ui/core'
...
const Header: FC<HeaderProps> = ({ siteTitle = '', onToggleTheme, onChangeTab }) => {
  ...
  return (
    <AppBar component="header" position="static" ref={rootRef}>
      <Toolbar className={classes.toolbar}>
        ...
        <div>
          <ButtonBase component={GatsbyLink} to="https://github.com/androiddevbr/resultados-pesquisa/data"  >
